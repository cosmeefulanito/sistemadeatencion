        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Perfil Administrador</span>
            </a>
            <ul class="dropdown-menu">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Optionally, you can add icons to the links -->
         ...
         <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Nutricionistas</span>
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('pacientes.create') }}">Paciente Nuevo</a></li>
            <li><a href="{{ route('pacientes.index')}}">Paciente Existente</a></li>
          </ul>
        </li>
        <li><a href="#"><i class="fa fa-link"></i> <span>Seguimiento</span></a></li>
